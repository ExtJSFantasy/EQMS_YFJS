...
//added
@property (nonatomic, retain) IBOutlet LBXScanView* reticleView;
...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    if (_reticleView) {
        [_reticleView stopScanAnimation];
    }
}
...
- (void)startCapturing {
    ...
    //added
    [_reticleView startScanAnimation];
}
...
- (UIView*)buildOverlayView {
    ...
    rectArea = CGRectMake(0, 0,
                          rootViewWidth,
                          rootViewHeight - toolbarHeight);*/
    //added
    CGFloat minAxis = MIN(rootViewHeight - toolbarHeight, rootViewWidth - toolbarHeight);
    
    rectArea = CGRectMake(
                          0.5 * (rootViewWidth - minAxis),
                          0.5 * (rootViewHeight - minAxis),
                          minAxis,
                          minAxis - toolbarHeight
                          );
    LBXScanView* reticleView = [[LBXScanView alloc] initWithFrame:rectArea];
    _reticleView = reticleView;
